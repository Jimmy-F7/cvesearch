...
export function normalizeTriageRecord(record: TriageRecord): TriageRecord {
  return {
    cveId: record.cveId,
...
export function buildTriageActivity(previous: TriageRecord, next: TriageRecord): AuditLogEntry[] {
