            ...
            {loading && (
              <div className="mt-4 animate-fade-in">
                <div className="flex items-center gap-3 rounded-xl border border-cyan-500/20 bg-cyan-500/[0.06] px-4 py-3">
                  ...
                  <div className="min-w-0">
                    <p className="text-sm font-medium text-cyan-200">Analyzing your prompt&hellip;</p>
                    <p className="mt-0.5 text-xs text-white/35">The AI is interpreting your query and building structured filters.</p>
                  </div>
                </div>
